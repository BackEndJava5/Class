		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form role="form" action="/board/modify" method="post">
					...
					<input type='hidden' name='amount' value='<c:out value="${cri.amount }"/>'> <input type='hidden' name='type' value='<c:out value="${cri.type }"/>'> <input type='hidden' name='keyword' value='<c:out value="${cri.keyword }"/>'>
